...
#![forbid(unsafe_code)]
#![doc = "Source-free synthetic macOS local-VM host-interruption supervisor."]

use std::{env, path::PathBuf, time::Duration};

use context_analyzer_runner::MacOsVmSyntheticSupervisor;
...
fn run() -> Result<Vec<u8>, ()> {
    ...
    .execute_host_interruption(&job_id)
    .map_err(|_| ())?;
