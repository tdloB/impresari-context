...
| [ADR-0059](0059-operator-authenticated-codex-home.md) | Use only an explicit dedicated operator-authenticated Codex home for guided delivery | Accepted; live admission evidence pending |
