...
| [ADR-0103](0103-separate-yara-x-production-artifact-ruleset-and-release-admission.md) | Separate YARA-X engine, ruleset, and release-binding admission before production activation | Source-free contract evaluator implemented; activation not authorized |
