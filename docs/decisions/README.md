...
| [ADR-0060](0060-copilot-programmatic-prompt-guided-delivery.md) | Deliver reviewed packets through Copilot CLI's zero-tool programmatic prompt surface | Accepted; implementation and live admission pending |
