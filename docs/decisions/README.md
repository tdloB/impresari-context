...
| [ADR-0079](0079-linux-production-lifecycle-contract.md) | Use one source-free install-through-uninstall lifecycle contract for both selected Linux profiles | Accepted; contract-level candidate only, hosted package rehearsals pending |
| [ADR-0080](0080-linux-package-lifecycle-rehearsal.md) | Rehearse exact A+C package replacement and rollback without faking rootless login reentry | Accepted; hosted evidence pending, production closed |
