...
| [ADR-0043](0043-source-free-client-lifecycle-maintenance.md) | Use on-demand source-free compatibility checks instead of background client control | Accepted; GitHub Copilot CLI and Claude Code scopes implemented |
