...
| [ADR-0063](0063-dedicated-agent-evaluation-harness-pull-request.md) | Isolate the completed agent-evaluation harness in a dedicated new pull request before SWE-bench work | Proposed for sequence-1 review |
