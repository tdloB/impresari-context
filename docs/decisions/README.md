...
| [ADR-0095](0095-freeze-yara-adapter-contract-before-execution.md) | Freeze a synthetic-only YARA adapter and normalization contract before execution | Accepted for contract-only implementation; execution gated |
| [ADR-0096](0096-freeze-yara-supply-chain-admission-contract.md) | Freeze exact YARA source selection and future executable/ruleset admission requirements | Accepted for contract-only implementation; artifacts and execution gated |
