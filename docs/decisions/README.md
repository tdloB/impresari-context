...
| [ADR-0073](0073-evidence-only-hostile-repository-admission.md) | Add static-first, evidence-only hostile-repository admission contracts | Proposed; implementation not authorized |
