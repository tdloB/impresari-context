...
| [ADR-0072](0072-local-metadata-dashboard-and-narrowing-budget-policy.md) | Use a loopback metadata dashboard and narrowing-only budget policy | Accepted; staged implementation |
...
| [ADR-0083](0083-v0-2-independent-security-review-gate.md) | Require an attributable independent human security review before the proposed v0.2.0 release | Accepted; release gate retained, scheduling amended by ADR-0084 |
| [ADR-0084](0084-defer-independent-review-to-release-candidate.md) | Backlog reviewer engagement until the final v0.2.0 release candidate without waiving the release gate | Accepted |
