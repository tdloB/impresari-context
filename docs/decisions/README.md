...
| [ADR-0083](0083-v0-2-independent-security-review-gate.md) | Require an attributable independent human security review before the proposed v0.2.0 release | Accepted for preparation; manual review required |
