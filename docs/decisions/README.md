...
| [ADR-0061](0061-claude-safe-mode-programmatic-guided-delivery.md) | Deliver reviewed packets through Claude Code's safe-mode programmatic print surface | Accepted for implementation; live admission pending |
