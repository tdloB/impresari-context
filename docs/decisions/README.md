...
| [ADR-0105](0105-diagnose-yara-x-build-reproducibility-before-retention.md) | Diagnose changed YARA-X executable identities with four ephemeral offline builds before retention | Accepted for no-upload implementation; hosted evidence pending |
