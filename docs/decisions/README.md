...
| [ADR-0100](0100-freeze-yara-x-ndjson-adapter-before-runner-linkage.md) | Freeze a pure fail-closed YARA-X NDJSON parser before any runner linkage | Accepted for original-synthetic implementation; execution and production gated |
