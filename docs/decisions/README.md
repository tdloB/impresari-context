...
| [ADR-0073](0073-evidence-only-hostile-repository-admission.md) | Add static-first, evidence-only hostile-repository admission contracts | Accepted and implemented through HRA-1; HRA-2 not authorized |
