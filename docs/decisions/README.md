...
| [ADR-0081](0081-linux-external-lifecycle-evidence-composition.md) | Compose exact C package, topology, interruption, crash, cleanup, and health-withdrawal evidence | Accepted; hosted composition pending, production closed |
