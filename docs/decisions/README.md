...
| [ADR-0106](0106-author-and-independently-review-yara-x-production-ruleset.md) | Author a minimal project-owned YARA-X production ruleset under a closed language, corpus, provenance, and independent-review boundary | Proposed; founder approval and independent human ruleset review required |
