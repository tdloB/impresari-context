...
| [ADR-0104](0104-retain-no-secret-yara-x-linux-engine-candidate.md) | Retain one no-secret Linux x86-64 YARA-X engine candidate as a short-lived authenticated non-release CI artifact | Approved and implemented; first authorized dispatch pending |
