...
| [ADR-0099](0099-build-yara-x-synthetic-compatibility-candidate.md) | Build a narrowed YARA-X v1.20.0 candidate and run only original-synthetic fixtures in the Linux CI boundary | Accepted for bounded synthetic implementation; no artifact, production, or IAR-2 admission |
