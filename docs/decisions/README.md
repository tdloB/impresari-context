...
| [ADR-0102](0102-compose-real-yara-x-synthetic-output-with-frozen-adapter.md) | Compose real YARA-X output from only generated synthetic cases with the frozen adapter | Implemented; hosted synthetic matrix pending; production and IAR-2 gated |
