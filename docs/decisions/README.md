...
| [ADR-0101](0101-prove-synthetic-runner-to-adapter-envelope-before-artifact-admission.md) | Prove bounded synthetic process-output composition before production artifact work | Accepted for contract-only implementation; YARA-X execution and production gated |
