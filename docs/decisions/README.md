...
| [ADR-0087](0087-macos-local-vm-analyzer-confinement.md) | Replace the failed macOS XPC execution boundary with a fresh local VM candidate | Partial synthetic fault matrix passed; full admission pending |
