...
| [ADR-0092](0092-freeze-windows-native-feasibility-contract.md) | Freeze the exact Windows native profile and prove a no-worker hosted capability preflight | Accepted for implementation; worker confinement gated |
