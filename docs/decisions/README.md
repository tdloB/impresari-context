...
| [ADR-0078](0078-linux-isolation-production-delegation.md) | Select rootless user-manager, administrator-provisioned, or externally managed Linux production delegation | Proposed; rootless-first recommendation requires founder decision |
