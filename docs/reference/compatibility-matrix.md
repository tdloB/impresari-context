...
| ADR-0088/0092/0093 Windows native candidate | Native no-worker preflight passed; synthetic-worker contract frozen; execution pending | PR 181 run `33361303368`, job `99393036278`, passed on Windows Server 2025 build `26100` x86-64 from source `393bc0b40d57fad0a5cb88cfe22394148f6bf464`. It verified NTFS, required APIs, empty Job Object set/query, and a unique zero-capability AppContainer create/derive/delete lifecycle against base profile `sha256:6b8f614387fc97321497e6b725213b9ee3c2159f3d1384fb800ffbe8af490a73`. ADR-0093 adds an unexecuted 19-scenario worker contract under matrix profile `sha256:82ab5c5c0cff76079ae19925b92da23b2d86e3a31e7cfc58626e17cb01c14678`. | One mutable hosted-build no-worker observation only. No worker has run inside AppContainer. Network/path/resource/descendant denial, full cleanup, multi-host evidence, signing, production admission, Windows IAR-1B, and real analyzers remain unverified. |
