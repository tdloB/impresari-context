...
| ADR-0088/0092 Windows native candidate | Native no-worker preflight passed; worker confinement pending | PR 181 run `33361303368`, job `99393036278`, passed on Windows Server 2025 build `26100` x86-64 from source `393bc0b40d57fad0a5cb88cfe22394148f6bf464`. It verified NTFS, required APIs, empty Job Object set/query, and a unique zero-capability AppContainer create/derive/delete lifecycle against profile `sha256:6b8f614387fc97321497e6b725213b9ee3c2159f3d1384fb800ffbe8af490a73`. | One mutable hosted-build observation only. No worker has run inside AppContainer. Network/path/resource/descendant denial, full cleanup, multi-host evidence, signing, production admission, Windows IAR-1B, and real analyzers remain unverified. |
