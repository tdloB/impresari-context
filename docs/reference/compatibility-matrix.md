...
| ADR-0074 Linux IAR-1B candidate | Native x86_64/arm64 and held-out 6.8/7.0 kernel composites passed; production scope pending | PR 131 job `99197119262` passed x86_64 and PR 132 job `99198568879` passed arm64 on `6.17.0-1022-azure`, Landlock ABI 7. PR 133 jobs `99200027090` and `99200027056` passed x86_64 on `6.8.0-1064-azure`/ABI 4 and `7.0.0-1012-azure`/ABI 8. | Exact-host receipts set `os_confined=true`; no real analyzer or production admission. Support, freshness, withdrawal, and maintenance contracts remain required. |
