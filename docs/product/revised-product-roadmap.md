...
| 4 | Java, Kotlin, C#, impact evidence, and incremental updates | In progress: bounded Java structural admission accepted after full hosted CI. Kotlin structural admission is underway; C# and impact-oriented evidence remain separate pending slices. |
