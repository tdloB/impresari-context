...
| 1 | Python and configuration evidence; first-class Codex, Claude Code, and Cursor kits | In progress: Python and narrow strict-JSON subset complete; remaining configuration formats and all first-class kits pending |
