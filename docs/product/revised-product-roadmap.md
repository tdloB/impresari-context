...
| 4 | Java, Kotlin, C#, impact evidence, and incremental updates | In progress: bounded Java structural admission. Kotlin, C#, and impact-oriented evidence remain separate pending slices. |
