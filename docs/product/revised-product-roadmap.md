...
| 1 | Python and configuration evidence; first-class Codex, Claude Code, and Cursor kits | In progress: Python, narrow strict-JSON, bounded JSONC, and Codex's non-mutating pre-admission kit complete; TOML, YAML, and all first-class admissions pending |
