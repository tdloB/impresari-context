...
| 1 | Python and configuration evidence; first-class Codex, Claude Code, and Cursor kits | In progress: Python, narrow strict-JSON, and Codex's non-mutating pre-admission kit complete; remaining configuration formats and all first-class admissions pending |
