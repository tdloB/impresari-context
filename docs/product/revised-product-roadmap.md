...
fixture provenance. HRA-2 is in progress with closed npm lifecycle and canonical
Compose privileged-service corpora plus exact key-token evidence. None of these records authorizes scanner execution,
