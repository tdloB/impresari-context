...
| 4 | Java, Kotlin, C#, impact evidence, and incremental updates | In progress: bounded Java, Kotlin, C#, structural-impact, declared change-set, and caller-declared associated-test evidence are accepted after full hosted CI. Repository-orientation packets are in hosted acceptance; incremental-update, convention, and exemplar evidence remain separately admitted. |
