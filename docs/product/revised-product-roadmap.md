...
| 4 | Java, Kotlin, C#, impact evidence, and incremental updates | In progress: bounded Java and Kotlin structural admissions accepted after full hosted CI. C# and impact-oriented evidence remain separate pending slices. |
